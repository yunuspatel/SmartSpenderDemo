			...
			datasets: [
				{
					...
					backgroundColor: "rgba(177,0,88,0.8)",
					borderColor: "rgba(177,0,88,0.8)",
					pointBackgroundColor: "rgba(177,0,88,1)",
					pointBorderColor: "#fff",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "rgba(177,0,88,1)",
					data: [65, 59, 90, 81, 56, 55, 40]
				},
				{
					label: "My Second dataset",
					backgroundColor: "rgba(242,183,1,0.8)",
					borderColor: "rgba(242,183,1,0.8)",
					pointBackgroundColor: "rgba(242,183,1,1)",
					pointBorderColor: "#fff",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "rgba(242,183,1,1)",
