...
<script type="text/javascript">
	function checkActive() {
		var element = document.getElementById('page-list-users');
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active"><span>List All Registered Users</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">All User's List</h6>
								</div>
										...
										<div class="">
											<table id="myTable1" class="table table-hover display  pb-30">
												...
												<tbody>
													...
													%>
													<c:forEach var="users"
														items="${ sessionScope.usersList }">
														<tr>
															<td><%=count++%></td>
															<td><a style="color: blue"
																href='<%= request.getContextPath() %>/SuperUserController?flag=loadSpecificUser&userId=${ users.userId }'>${ users.userName }</a></td>
															<td>${ users.userEmail }</td>
															<td>${ users.userMobile }</td>
															<td><a href="<%= request.getContextPath() %>/SuperUserController?flag=reactivateUserAccount&userId=${ users.userId }" class="btn btn-primary btn-icon-anim btn-circle btn-sm"><i class="icon-user"></i></a></td>
															<td><a href="<%= request.getContextPath() %>/SuperUserController?flag=revokeStockPermission&userId=${ users.userId }" class="btn btn-danger btn-icon-anim btn-circle btn-sm"><i class="icon-settings"></i></a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
